...
<body>
    ...
    <section>
        <div>
        <h1 class="center">Recently Bought Items</h1>
            <?php
                $recommendation_name = "";
                ...
                if (isset($_SESSION['username'])){
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<img src='$image' style='width:500px; height:400px; border-radius:10px;'><br>";
                        echo "<h3>{$row['food_name']}</h3>";
                        echo "<p>Price: \${$row['current_price']}</p>";
                        echo "</div>";
                    }
                } else {
                    echo '<h2> Please login first to see history </h2>';
                }
?>

        </div>
        <div>
        <h1 class="center">Recommendation From Your Previous Purchase</h1>
        <br>
        <br>
        <br>
        <br>
        ...
        <?php
            if ($recommendation_name !== "") {
                ...
                echo "<img src='$recommendation_image' height='500' width='500' style='border-radius:10px;'>";
            } else {
